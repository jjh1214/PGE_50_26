...
def generate_launch_description():
    ...
    pkg_path = get_package_share_directory("pge_50_26_description")
    urdf_file = os.path.join(pkg_path, "urdf", "pge_50_26.urdf")
    with open(urdf_file, "r") as file:
        robot_description = file.read()

    params = {"robot_description": robot_description, "use_sim_time": use_sim_time}

    rviz_config_file = pkg_path + "/rviz/default.rviz"
